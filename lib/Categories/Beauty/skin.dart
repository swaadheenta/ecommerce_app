...
class _skinState extends State<skin> {
  ...
  String default_choice = "Body Lotion";
  int default_index = 0;
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                        ...
                        iconSize: 30.0,
                        style: TextStyle(color: Colors.blue),
                        items: ["Body Lotion", "Facewash & Rose Water","Lip Care"].map(
                          (val) {
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "Select a category :-",
                        style:
                            TextStyle(fontSize: displayWidth(context) * 0.055,fontFamily: "BreeSerif",fontWeight: FontWeight.w500),
                      ),
                    ),
                    Container(
                        child: Column(
