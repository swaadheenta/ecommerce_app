...
class fruitjuices extends StatefulWidget {
  @override
  _fruitjuicesState createState() => _fruitjuicesState();
}

class _fruitjuicesState extends State<fruitjuices> {
                  ...
                  Card(
                    ...
                    child: Container(
                      ...
                      child: DropdownButton(
                        ...
                        iconSize: 30.0,
                        style: TextStyle(color: Colors.blue),
                        items: ['Juices', 'Unsweetened, Cold Press','Syrups & Concentrates'].map(
                          (val) {
