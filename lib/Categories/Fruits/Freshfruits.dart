...
class _ffState extends State<ff> {
  String default_choice = "Apples,Banana & Pomegranate";
  int default_index = 0;
  List<category> categorylist = [
    category(
      name: "Apples,Banana & Pomegranate",
      index: 0,
    ),
    category(
      name: "Melon, Papaya & Citrus Fruits",
      index: 1,
    ),
  ];
                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: DropdownButton(
                              ...
                              style: TextStyle(color: Colors.blue),
                              items: [
                                "Apples,Banana & Pomegranate",
                                "Melon, Papaya & Citrus Fruits",
                              ].map(
                                (val) {
